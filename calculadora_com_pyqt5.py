...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculadora com PyQt')  # Titulo
        self.setFixedSize(400, 400)  # Fixa tamanho da janela
        self.cw = QWidget()
        ...
        self.add_btn(QPushButton('7'), 1, 0, 1, 1)  # Linha, Coluna, dos botões
        ...
        self.add_btn(
            ...
            'background: #E8C47F; color: #fff; font-weight: 700'
        )
